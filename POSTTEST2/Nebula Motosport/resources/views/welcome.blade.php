        ...
        <div class="grid gap-12 md:grid-cols-4">
            @foreach ($products as $product)
                <article
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-2 tracking-wide">{{ $product['name'] }}</h3>
                        <p class="text-indigo-600 font-bold text-lg mb-6">${{ number_format($product['price'], 0) }}</p>
                        <a href="#"
                            class="block text-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-full shadow-md transition-transform transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-indigo-400">
                            View Details
                        </a>
                    </div>
                </article>
