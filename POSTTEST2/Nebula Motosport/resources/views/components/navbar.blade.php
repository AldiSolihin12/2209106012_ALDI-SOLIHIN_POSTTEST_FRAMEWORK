<nav class="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-md">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center min-w-max">
        ...
        <ul class="hidden md:flex space-x-10 text-gray-700 font-semibold tracking-wide">
            <li><a href="#home" class="relative group py-2 px-1 hover:text-indigo-600 transition">
                    Home
                    <span
                        class="absolute left-0 -bottom-1 w-0 group-hover:w-full h-0.5 bg-indigo-600 rounded transition-all"></span>
                </a></li>
            <li><a href="#products" class="relative group py-2 px-1 hover:text-indigo-600 transition">
                    Products
                    <span
                        class="absolute left-0 -bottom-1 w-0 group-hover:w-full h-0.5 bg-indigo-600 rounded transition-all"></span>
                </a></li>
            <li><a href="#about" class="relative group py-2 px-1 hover:text-indigo-600 transition">
                    About
                    <span
                        class="absolute left-0 -bottom-1 w-0 group-hover:w-full h-0.5 bg-indigo-600 rounded transition-all"></span>
                </a></li>
            <li><a href="#contact" class="relative group py-2 px-1 hover:text-indigo-600 transition">
                    Contact
                    <span
                        class="absolute left-0 -bottom-1 w-0 group-hover:w-full h-0.5 bg-indigo-600 rounded transition-all"></span>
                </a></li>
